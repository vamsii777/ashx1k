...
class ProductCollectionHeaderListAdapter(private val dataBindingComponent: DataBindingComponent,
                                         ...
                                         private val diffUtilDispatchedInterface: DiffUtilDispatchedInterface2?) : DataBoundListAdapter<ProductCollectionHeader?, ItemProductCollectionHeaderListAdapterBinding?>() {
