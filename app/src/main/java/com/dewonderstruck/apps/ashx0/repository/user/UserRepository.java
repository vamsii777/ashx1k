...
public class UserRepository extends PSRepository{
    ...
    public LiveData<Resource<UserLogin>> doLogin(String apiKey, String email, String password) {
        ...
        return new NetworkBoundResource2<UserLogin, User>(appExecutors) {
...
//                        userDao.insert(userLogin);
    ...
    public LiveData<Resource<User>> updateUser(String apiKey, User user) {
        ...
        return new NetworkBoundResource2<User, User>(appExecutors) {
...
//                    }
    ...
    public LiveData<Resource<ApiStatus>> forgotPassword(String apiKey, String email) {
        ...
        return new NetworkBoundResource2<ApiStatus, ApiStatus>(appExecutors) {
