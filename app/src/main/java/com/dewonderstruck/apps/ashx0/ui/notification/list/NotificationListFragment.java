...
import com.dewonderstruck.apps.ashx0.databinding.FragmentNotificationListBinding;
...
public class NotificationListFragment extends PSFragment implements DataBoundListAdapter.DiffUtilDispatchedInterface {
    ...
    private void replaceData(List<com.dewonderstruck.apps.ashx0.viewobject.Noti> notificationList) {
