...
class ProductVerticalListAdapter(private val dataBindingComponent: DataBindingComponent,
                                 private val callback: NewsClickCallback?, private val diffUtilDispatchedInterface: DiffUtilDispatchedInterface2?) : DataBoundListAdapter<Product?, ItemProductVerticalListAdapterBinding?>() {
