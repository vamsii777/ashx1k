...
class BlogListFragment : DeFragment(), DiffUtilDispatchedInterface2 {
    ...
    override fun initAdapters() {
        val nvAdapter = BlogListAdapter(dataBindingComponent,
                object : BlogListAdapter.NewsClickCallback{
