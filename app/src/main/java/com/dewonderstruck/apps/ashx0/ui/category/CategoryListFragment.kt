...
class CategoryListFragment : PSFragment(), DiffUtilDispatchedInterface {
    //region Variables
...
*/
    ...
    private fun loadCategory() {
        ...
        categoryViewModel!!.nextPageLoadingStateData.observe(this, Observer<Resource<Boolean?>> { state: Resource<Boolean?>? ->
            if (state != null) {
