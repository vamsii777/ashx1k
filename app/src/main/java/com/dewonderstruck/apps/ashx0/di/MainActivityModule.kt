...
import com.dewonderstruck.apps.ashx0.ui.checkout.*
...
internal abstract class MainActivityModule {
    ...
    abstract fun commentDetailActivity(): CommentDetailActivity?
    ...
    abstract fun commentListActivity(): CommentListActivity?

    @ContributesAndroidInjector(modules = [BasketlistActivityModule::class])
    abstract fun basketListActivity(): BasketListActivity?
    ...
    abstract fun ratingListActivity(): RatingListActivity?
...
internal abstract class CheckoutActivityModule {
    ...
    abstract fun checkoutFragment1(): CheckoutFragment1?

    @ContributesAndroidInjector
    abstract fun languageFragment(): LanguageFragment?

    @ContributesAndroidInjector
    abstract fun checkoutFragment2(): CheckoutFragment2?

    @ContributesAndroidInjector
    abstract fun checkoutFragment3(): CheckoutFragment3?

    @ContributesAndroidInjector
    abstract fun checkoutStatusFragment(): CheckoutStatusFragment?
}
...
internal abstract class MainModule {
    ...
    @ContributesAndroidInjector
    abstract fun basketFragment(): BasketListFragment?
...
@Module
internal abstract class CommentDetailModule {
    @ContributesAndroidInjector
    abstract fun commentDetailFragment(): CommentDetailFragment?
}
...
@Module
internal abstract class RatingListActivityModule {
    @ContributesAndroidInjector
    abstract fun contributeRatingListFragment(): RatingListFragment?
}
...
@Module
internal abstract class CommentListActivityModule {
    @ContributesAndroidInjector
    abstract fun contributeCommentListFragment(): CommentListFragment?
}

@Module
internal abstract class BasketlistActivityModule {
    @ContributesAndroidInjector
    abstract fun contributeBasketListFragment(): BasketListFragment?
}
...
internal abstract class SearchByCategoryActivityModule {
    ...
    @ContributesAndroidInjector
    abstract fun contributeSearchCountryListFragment(): SearchCountryListFragment?
}
