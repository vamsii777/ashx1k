...
public class CommentListViewModel extends PSViewModel {
    ...
    private MutableLiveData<com.dewonderstruck.apps.ashx0.viewmodel.comment.CommentListViewModel.TmpDataHolder> sendCommentHeaderPostDataObj = new MutableLiveData<>();
    ...
    public void setSendCommentHeaderPostDataObj(String product_id,
        ...
        if (!isLoading) {
            com.dewonderstruck.apps.ashx0.viewmodel.comment.CommentListViewModel.TmpDataHolder tmpDataHolder = new com.dewonderstruck.apps.ashx0.viewmodel.comment.CommentListViewModel.TmpDataHolder();
