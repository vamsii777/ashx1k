...
class ProfileEditFragment : DeFragment() {
    ...
    override fun initUIAndActions() {
        ...
        if (context != null) {
            ...
            binding!!.get().nameProfile.text = context!!.getString(R.string.edit_profile__user_name)
            binding!!.get().emailTextView.text = context!!.getString(R.string.edit_profile__email)
            binding!!.get().phoneProfile.text = context!!.getString(R.string.edit_profile__phone)
            binding!!.get().aboutMeTextView.text = context!!.getString(R.string.edit_profile__about_me)
        }
        ...
        binding!!.get().passwordChangeButton.setOnClickListener { view: View? -> navigationController.navigateToPasswordChangeActivity(requireActivity()) }
        binding!!.get().countrySelectionView.setOnClickListener { v: View? -> navigationController.navigateToSearchActivityCategoryFragment(requireActivity(), Constants.COUNTRY, Constants.NO_DATA, Constants.NO_DATA, userViewModel!!.countryId, userViewModel!!.cityId) }
        binding!!.get().citySelectionView.setOnClickListener { v: View? ->
            if (binding!!.get().countryTextView.text.toString() == Constants.EMPTY_STRING) {
                ...
                navigationController.navigateToSearchActivityCategoryFragment(requireActivity(), Constants.CITY, Constants.NO_DATA, Constants.NO_DATA, userViewModel!!.countryId, userViewModel!!.cityId)
            }
        }
    }
