...
public class ProfileFragment extends PSFragment implements DataBoundListAdapter.DiffUtilDispatchedInterface {
    ...
    protected void initUIAndActions() {
        ...
        binding.get().segmentEdit.setOnClickListener(view -> navigationController.navigateToProfileEditActivity(getActivity()));
        ...
        binding.get().segFav.setOnClickListener(view -> navigationController.navigateToFavouriteActivity(getActivity()));
        binding.get().segmentFavheart.setOnClickListener(view -> navigationController.navigateToFavouriteActivity(getActivity()));
        binding.get().segmentSettings.setOnClickListener(view -> navigationController.navigateToSettingActivity(getActivity()));
...
//            transactionListViewModel.setTransactionListObj(String.valueOf(Config.LOAD_FROM_DB), String.valueOf(transactionListViewModel.offset), loginUserId);
    ...
    private void replaceUserData(User user) {
        ...
        binding.get().segmentEdit.setText(binding.get().segmentEdit.getText().toString());
        ...
        binding.get().segmentSettings.setText(binding.get().segmentSettings.getText().toString());
        ...
        binding.get().joinDate.setText(binding.get().joinDate.getText().toString());
        binding.get().joinedDate.setText(user.addedDate);
        binding.get().nameProfile.setText(user.userName);
        binding.get().phoneProfile.setText(user.userPhone);
