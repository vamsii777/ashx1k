...
public class ProfileEditFragment extends PSFragment {
    ...
    protected void initUIAndActions() {
        ...
        if (getContext() != null) {
            ...
            binding.get().nameProfile.setText(getContext().getString(R.string.edit_profile__user_name));
            binding.get().emailTextView.setText(getContext().getString(R.string.edit_profile__email));
            binding.get().phoneProfile.setText(getContext().getString(R.string.edit_profile__phone));
