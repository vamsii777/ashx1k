...
@Singleton
public class TransactionOrderRepository extends DeRepository {
    ...
    public LiveData<Resource<List<TransactionDetail>>> getTransactionOrderList(String apiKey, String transactionHeaderId, String offset) {
        ...
        return new NetworkBoundResource2<List<TransactionDetail>, List<TransactionDetail>>(appExecutors) {
