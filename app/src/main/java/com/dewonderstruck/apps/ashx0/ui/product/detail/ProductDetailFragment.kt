 ...
 */
class ProductDetailFragment : DeFragment(), DiffUtilDispatchedInterface2 {
    //region Variables
    ...
    override fun initUIAndActions() {
        ...
        if (context != null) {
            ...
            mBottomSheetDialog = AutoClearedValue(this, BottomSheetDialogExpanded(requireContext()))
        ...
        binding!!.get()!!.messengerFloatingActionButton.setOnClickListener { v: View? ->
            try {
                ...
                intent.data = Uri.parse("https://m.me/$messenger")
                startActivity(intent)
            } catch (e: Exception) {
                e.printStackTrace()
                Toast.makeText(activity, getString(R.string.product_detail__install_messenger_app), Toast.LENGTH_SHORT).show()
            }
        }
        binding!!.get()!!.whatsappFloatingActionButton.setOnClickListener { v: View? ->
            try {
                ...
                e.printStackTrace()
                Toast.makeText(activity, getString(R.string.product_detail__install_whatsapp_app), Toast.LENGTH_SHORT).show()
            }
        }
    ...
    override fun initAdapters() {
        //view pager slide
        val pagerAdapter = ProductDetailListPagerAdapter(dataBindingComponent,
                object : ProductDetailListPagerAdapter.ImageClickCallback {
                    override fun onItemClick(view: View?, obj: Image?, position: Int) {
                        navigationController.navigateToGalleryActivity(activity!!, Constants.IMAGE_TYPE_PRODUCT, productDetailViewModel!!.productId)
                    }
        ...
        val nvcolorAdapter = ProductColorAdapter(dataBindingComponent,
                object : ColorClickCallBack {
                    override fun onClick(productColor: ProductColor?, selectedColorId: String?, selectedColorValue: String?) {
                        productColorViewModel!!.colorSelectId = selectedColorId
                        productColorViewModel!!.colorSelectValue = selectedColorValue
        ...
        val tabAdapter = ProductDetailTagAdapter(dataBindingComponent,
                object : SimilarProductClickCallBack {
                    override fun onClick(tabObject: TabObject?, selectedTabId: String?) {
                        when (tabObject!!.field_name) {
                            Constants.CATEGORY -> {
                                productParameterHolder.resetTheHolder()
                                productParameterHolder.catId = tabObjectList!!.get()[0].tag_id
                                navigationController.navigateToHomeFilteringActivity(activity!!, productParameterHolder, tabObjectList!!.get()[0].tag_name)
                            }
                            Constants.SUBCATEGORY -> {
                                productParameterHolder.resetTheHolder()
                                productParameterHolder.catId = tabObjectList!!.get()[0].tag_id
                                productParameterHolder.subCatId = tabObjectList!!.get()[1].tag_id
                                navigationController.navigateToHomeFilteringActivity(activity!!, productParameterHolder, tabObjectList!!.get()[1].tag_name)
                            }
                            Constants.PRODUCT_TAG -> {
                                productParameterHolder.resetTheHolder()
                                productParameterHolder.search_term = tabObject.tag_name
                                navigationController.navigateToHomeFilteringActivity(activity!!, productParameterHolder, tabObject.tag_name)
                            }
                        }
                    }
                })
        ...
        //specs
        val specsAdapter = ProductDetailSpecsAdapter(dataBindingComponent, object : SpecsClickCallBack {
            override fun onClick(productSpecs: ProductSpecs?) {
        ...
        val headerAdapter: ProductAttributeHeaderAdapter = object : ProductAttributeHeaderAdapter(dataBindingComponent, productAttributeHeaderViewModel!!.basketItemHolderHashMap,
                object : HeaderProductClickCallBack {
                    override fun onClick(productAttributeDetail: ProductAttributeDetail?) {
                        ...
                        if (productAttributeDetail!!.id == "-1") {
                            ...
                            productAttributeHeaderViewModel!!.basketItemHolderHashMap[productAttributeDetail.headerId] = productAttributeDetail.name
                        }
                        additionPrice = productAttributeDetail.additionalPrice
                        productAttributeHeaderViewModel!!.attributeHeaderHashMap[productAttributeDetail.headerId] = additionPrice!!.toInt()
                        ...
                        for (item in productAttributeHeaderViewModel!!.attributeHeaderHashMap.values) {
                            productAttributeHeaderViewModel!!.priceAfterAttribute += item.toFloat()
                            productAttributeHeaderViewModel!!.originalPriceAfterAttribute += item.toFloat()
                        }
                        if (binding != null && binding!!.get() != null && binding!!.get()!!.priceTextView != null) {
                            binding!!.get()!!.priceTextView.text = Utils.format(productAttributeHeaderViewModel!!.priceAfterAttribute.toDouble()).toString()
                            binding!!.get()!!.originalPriceTextView.text = getString(R.string.product_detail__original_price, productDetailViewModel!!.currencySymbol, Utils.format(productAttributeHeaderViewModel!!.originalPriceAfterAttribute.toDouble()).toString())
                        }
                        if (bottomBoxLayoutBinding != null && bottomBoxLayoutBinding!!.get() != null && bottomBoxLayoutBinding!!.get()!!.priceTextView != null) {
                            bottomBoxLayoutBinding!!.get()!!.priceTextView.text = Utils.format(productAttributeHeaderViewModel!!.priceAfterAttribute.toDouble()).toString()
                            bottomBoxLayoutBinding!!.get()!!.originalPriceTextView.text = getString(R.string.product_detail__original_price, productDetailViewModel!!.currencySymbol, Utils.format(productAttributeHeaderViewModel!!.originalPriceAfterAttribute.toDouble()).toString())
                        }
                    }
                }) {}
...
//                }
    ...
    override fun initData() {
        try {
            if (activity != null) {
                if (requireActivity().intent.extras != null) {
                    productDetailViewModel!!.productId = requireActivity().intent.extras!!.getString(Constants.PRODUCT_ID)
                    productDetailViewModel!!.historyFlag = requireActivity().intent.extras!!.getString(Constants.HISTORY_FLAG)
                    productDetailViewModel!!.basketFlag = requireActivity().intent.extras!!.getString(Constants.BASKET_FLAG)
                    if (productDetailViewModel!!.basketFlag != null && productDetailViewModel!!.basketFlag == Constants.ONE) {
                        productDetailViewModel!!.price = requireActivity().intent.extras!!.getString(Constants.PRODUCT_PRICE)
                        productDetailViewModel!!.attributes = requireActivity().intent.extras!!.getString(Constants.PRODUCT_ATTRIBUTE)
                        productDetailViewModel!!.count = requireActivity().intent.extras!!.getString(Constants.PRODUCT_COUNT)
                        productDetailViewModel!!.colorId = requireActivity().intent.extras!!.getString(Constants.PRODUCT_SELECTED_COLOR)
                        productDetailViewModel!!.basketId = requireActivity().intent.extras!!.getInt(Constants.BASKET_ID)
        ...
        basketViewModel!!.basketSavedData.observe(this, Observer { resourse: Resource<Boolean?>? ->
            if (resourse != null) {
...
//                        productAttributeHeaderViewModel.attributeHeaderHashMap.clear();
        ...
        touchCountViewModel!!.touchCountPostData.observe(this, Observer { result: Resource<Boolean?>? ->
            if (result != null) {
                if (result.status == Status.SUCCESS) {
                    if (this@ProductDetailFragment.activity != null) {
                        Utils.psLog(result.status.toString())
                    }
                } else if (result.status == Status.ERROR) {
                    if (this@ProductDetailFragment.activity != null) {
    ...
    private fun LoadData() {
        // Load image
        val news = imageViewModel!!.imageListLiveData
        ...
        productDetailViewModel!!.setProductDetailObj(productDetailViewModel!!.productId, productDetailViewModel!!.historyFlag, loginUserId)
        setTouchCount()
        val productDetail = productDetailViewModel!!.productDetailData
        ...
        val productRelated = productRelatedViewModel!!.productRelatedData
        ...
        //load product color
        val productColor = productColorViewModel!!.productColorData
        ...
        //load product specs
        val productSpecs = productSpecsViewModel!!.productSpecsListData
        ...
        //load product header
        val productHeader = productAttributeHeaderViewModel!!.productAttributeHeaderListData
        productHeader?.observe(this, Observer { listResource: List<ProductAttributeHeader>? ->
            if (listResource != null && listResource.size > 0) {
                ...
                for (i in listResource.indices) {
                    productAttributeHeaderViewModel!!.headerIdList.add(listResource[i].id)
                }
        ...
        val productHeaderDetail = productAttributeDetailViewModel!!.productAttributeDetailListData
    ...
    private fun replaceProductDetailData(product: Product?) {
        ...
        bottomBoxLayoutBinding!!.get()!!.floatingbtnMinus.setOnClickListener { view: View? ->
            if (num != 1) {
                if (minOrder != 0) {
                    if (num <= minOrder) {
                        Toast.makeText(context, getString(R.string.product_detail__min_order_error) + Constants.SPACE_STRING + minOrder, Toast.LENGTH_SHORT).show()
...
//        binding.get().likeTextView.setOnClickListener(view -> sendLikePostData());
        ...
        binding!!.get()!!.desc.setOnClickListener { v: View? ->
            val show = Utils.toggleUpDownWithAnimation(binding!!.get()!!.descUpDownImageView)
            if (show) {
        ...
        binding!!.get()!!.textView39.setOnClickListener { v: View? ->
            val show = Utils.toggleUpDownWithAnimation(binding!!.get()!!.choiceUpDownImageView)
            if (show) {
                expandChoiceFunction()
            } else {
                collapseChoiceFunction()
        ...
        binding!!.get()!!.textview56.setOnClickListener { v: View? ->
            val show = Utils.toggleUpDownWithAnimation(binding!!.get()!!.tabUpDownImageView)
            if (show) {
                expandTabFunction()
            } else {
                collapseTabFunction()
        ...
        binding!!.get()!!.textView25.setOnClickListener { v: View? ->
            val show = Utils.toggleUpDownWithAnimation(binding!!.get()!!.detailUpDownImageView)
            if (show) {
                expandDetailFunction()
            } else {
                collapseDetailFunction()
        ...
        binding!!.get()!!.textview51.setOnClickListener { v: View? ->
            val show = Utils.toggleUpDownWithAnimation(binding!!.get()!!.strictUpDownImageView)
            if (show) {
                expandStrictFunction()
            } else {
                collapseStrictFunction()
        ...
        binding!!.get()!!.textview54.setOnClickListener { v: View? ->
            val show = Utils.toggleUpDownWithAnimation(binding!!.get()!!.seeMoreImageView)
            if (show) {
                expandSenceFunction(product)
            } else {
                collapseSenceFunction()
    ...
    private fun setSaveToBasket() {
        ...
        if (validateBasket()) {
            ...
            // save
            if (productAttributeHeaderViewModel!!.priceAfterAttribute == 0f) {
