...
public class ShopProfileFragment extends PSFragment {
    ...
    protected void initUIAndActions() {
        ...
        //For Phone 1
        binding.get().phoneTitleTextView.setOnClickListener(view1 -> {

            String number = binding.get().phoneTitleTextView.getText().toString();
...
*/
        ...
        if (shop.aboutPhone1.equals("")) {
            binding.get().phoneTitleTextView.setText(Constants.DASH);
        } else {
            binding.get().phoneTitleTextView.setText(shop.aboutPhone1);
        }
