...
class HomeFeaturedProductViewModel @Inject internal constructor(repository: ProductRepository) : PSViewModel() {
    ...
    @JvmField
    var productParameterHolder = ProductParameterHolder().featuredParameterHolder
