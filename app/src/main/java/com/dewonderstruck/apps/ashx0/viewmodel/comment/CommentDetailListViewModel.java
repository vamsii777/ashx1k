...
public class CommentDetailListViewModel extends PSViewModel {
    ...
    private MutableLiveData<com.dewonderstruck.apps.ashx0.viewmodel.comment.CommentDetailListViewModel.TmpDataHolder> sendCommentDetailPostDataObj = new MutableLiveData<>();
    //region Constructor
    ...
    public void setSendCommentDetailPostDataObj(String headerId,
        ...
        if (!isLoading) {
            com.dewonderstruck.apps.ashx0.viewmodel.comment.CommentDetailListViewModel.TmpDataHolder tmpDataHolder = new com.dewonderstruck.apps.ashx0.viewmodel.comment.CommentDetailListViewModel.TmpDataHolder();
