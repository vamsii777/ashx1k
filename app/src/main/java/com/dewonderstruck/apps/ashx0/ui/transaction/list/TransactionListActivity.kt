...
class TransactionListActivity : PSAppCompactActivity() {
    //region Override Methods
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        val binding: ActivityTransactionListBinding = DataBindingUtil.setContentView(this, R.layout.activity_transaction_list)
    ...
    private fun initUI(binding: ActivityTransactionListBinding) {

        // Toolbar
        initToolbar(binding.toolbar, resources.getString(R.string.transaction__title))
