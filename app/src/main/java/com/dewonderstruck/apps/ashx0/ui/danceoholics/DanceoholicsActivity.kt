...
class DanceoholicsActivity : PSAppCompactActivity() {
    protected var binding: ActivityDanceoholicsBinding? = null
    ...
    private fun initUI(binding: ActivityDanceoholicsBinding) {
        ...
        // Toolbar
        initToolbar(binding.toolbar, resources.getString(R.string.edit_danceoholics_title))
        // setup Fragment
        setupFragment(DanceholicsFragment())
    } //endregion
}