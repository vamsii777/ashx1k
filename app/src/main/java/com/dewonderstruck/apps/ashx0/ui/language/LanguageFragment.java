...
public class LanguageFragment extends PSFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        FragmentLanguageBinding dataBinding = (FragmentLanguageBinding) DataBindingUtil.inflate(inflater, R.layout.fragment_language, container, false, dataBindingComponent);
