...
class MainFragment : PSFragment(), DiffUtilDispatchedInterface {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        if (item.itemId == R.id.action_blog) {
            navigationController!!.navigateToBlogList(activity)
        }
    ...
    override fun initUIAndActions() {
        ...
        binding!!.get()!!.gotoyou.setOnClickListener {
            val intent = Intent(
                    Intent.ACTION_VIEW,
                    Uri.parse("https://www.youtube.com/channel/UCXsOq3SXWaSxeE7zNK9FgYA"))
            ...
            if (infos.size > 0) {
                ...
                intent.data = Uri.parse("https://www.youtube.com/channel/UCXsOq3SXWaSxeE7zNK9FgYA")
    ...
    override fun initAdapters() {
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        /*featuredList*/
        val viewPagerAdapter1 = ViewPagerAdapter(dataBindingComponent, ItemClick { product: Product? -> navigationController!!.navigateToDetailActivity(this@MainFragment.activity, product) })
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        /*CategoryIconList*/
        val categoryIconListAdapter1 = CategoryIconListAdapter(dataBindingComponent, CategoryIconListAdapter.CategoryClickCallback { category: Category ->
...
//        });
        ...
        val trendingCategoryAdapter = TrendingCategoryAdapter(dataBindingComponent,
                TrendingCategoryAdapter.CategoryClickCallback { category: Category ->
                    categoryViewModel!!.productParameterHolder.catId = category.id
                    navigationController!!.navigateToHomeFilteringActivity(this.activity, categoryViewModel!!.productParameterHolder, category.name)
                }, this)
    ...
    private fun deleteHistoryData() {
        ...
        clearAllDataViewModel!!.deleteAllDataData.observe(this, Observer<Resource<Boolean>> { result: Resource<Boolean>? ->
            if (result != null) {
                when (result.status) {
                    Status.ERROR -> {
                    }
    ...
    private fun loadProducts() {
            ...
            if (result != null) {
                when (result.status) {
                    Status.SUCCESS -> if (result.data != null) {
                        ...
                        pref!!.edit().putString(Constants.PAYMENT_SHIPPING_TAX_LABEL, result.data.shippingTaxLabel).apply()
                        pref!!.edit().putString(Constants.PAYMENT_OVER_ALL_TAX_LABEL, result.data.overallTaxLabel).apply()
                        pref!!.edit().putString(Constants.PAYMENT_CASH_ON_DELIVERY, result.data.codEnabled).apply()
                        pref!!.edit().putString(Constants.PAYMENT_PAYPAL, result.data.paypalEnabled).apply()
                        pref!!.edit().putString(Constants.PAYMENT_STRIPE, result.data.stripeEnabled).apply()
                        pref!!.edit().putString(Constants.MESSENGER, result.data.messenger).apply()
                        pref!!.edit().putString(Constants.WHATSAPP, result.data.whapsappNo).apply()
                    }
                    Status.ERROR -> {
                    }
                }
        ...
        homeLatestProductViewModel!!.setGetProductListByKeyObj(homeLatestProductViewModel!!.productParameterHolder, loginUserId!!, Config.LOAD_FROM_DB.toString(), java.lang.String.valueOf(homeLatestProductViewModel!!.offset))
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        homeFeaturedProductViewModel!!.setGetProductListByKeyObj(homeFeaturedProductViewModel!!.productParameterHolder, loginUserId!!, Config.LOAD_FROM_DB.toString(), java.lang.String.valueOf(homeFeaturedProductViewModel!!.offset))
        val featured: LiveData<Resource<List<Product>>> = homeFeaturedProductViewModel!!.getProductListByKeyData
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        /* CategoryRecyclerView*/categoryViewModel!!.setCategoryListObj(loginUserId!!, categoryViewModel!!.categoryParameterHolder, Config.LOAD_FROM_DB.toString(), java.lang.String.valueOf(homeSearchProductViewModel!!.offset))
...
//                                // Update the data
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        /*DiscountList*/homeSearchProductViewModel!!.setGetProductListByKeyObj(homeSearchProductViewModel!!.holder, loginUserId!!, Config.LOAD_FROM_DB.toString(), java.lang.String.valueOf(homeSearchProductViewModel!!.offset))
        val discount: LiveData<Resource<List<Product>>> = homeSearchProductViewModel!!.getProductListByKeyData
        ...
        /*DiscountList*/
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        /*trendingList*/homeTrendingProductViewModel!!.setGetProductListByKeyObj(homeTrendingProductViewModel!!.productParameterHolder, loginUserId!!, Config.LOAD_FROM_DB.toString(), java.lang.String.valueOf(homeSearchProductViewModel!!.offset))
        ...
        /*trendingList*/
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        /*trendingCategoryList*/homeTrendingCategoryListViewModel!!.setHomeTrendingCatrgoryListDataObj(homeTrendingCategoryListViewModel!!.categoryParameterHolder, Config.LOAD_FROM_DB.toString(), java.lang.String.valueOf(homeTrendingCategoryListViewModel!!.offset))
        ...
        /*Collection List*/productCollectionViewModel!!.setProductCollectionHeaderListForHomeObj(Config.COLLECTION_PRODUCT_LIST_LIMIT.toString(), Config.COLLECTION_PRODUCT_LIST_LIMIT.toString(), Config.COLLECTION_PRODUCT_LIST_LIMIT.toString(), java.lang.String.valueOf(homeTrendingCategoryListViewModel!!.offset))
        val productCollection: LiveData<Resource<List<ProductCollectionHeader>>> = productCollectionViewModel!!.productCollectionHeaderListDataForHome
