...
class NotificationFragment : PSFragment(), DiffUtilDispatchedInterface {
    ...
    override fun initData() {
        ...
        val notificationDetail: LiveData<Resource<Noti?>> = notificationViewModel!!.notificationDetailData
        ...
        notificationViewModel!!.notiReadData.observe(this, Observer<Resource<Boolean?>> { result: Resource<Boolean?>? ->
            if (result != null) {
