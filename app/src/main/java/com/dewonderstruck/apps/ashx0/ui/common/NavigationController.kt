...
class NavigationController @Inject constructor() {
    ...
    fun navigateToBasket(mainActivity: MainActivity) {
        if (checkFragmentChange(RegFragments.HOME_BASKET)) {
            try {
                val fragment = BasketListFragment()
                mainActivity.supportFragmentManager.beginTransaction()
                        .replace(containerId, fragment)
                        .commitAllowingStateLoss()
            } catch (e: Exception) {
    ...
    fun navigateToCommentListActivity(activity: Activity, product: Product) {
    ...
    fun navigateToBasketList(activity: Activity) {
        val intent = Intent(activity, BasketListActivity::class.java)
        activity.startActivity(intent)
    }

    fun navigateToRatingList(activity: Activity, productId: String?) {
    ...
    fun navigateToCommentDetailActivity(activity: Activity, comment: Comment) {
        val intent = Intent(activity, CommentDetailActivity::class.java)
    ...
    fun navigateToCheckoutActivity(activity: Activity) {
        val intent = Intent(activity, CheckoutActivity::class.java)
        activity.startActivityForResult(intent, Constants.REQUEST_CODE__BASKET_FRAGMENT)
    }

    fun navigateBackToBasketActivity(activity: Activity) {
        val intent = Intent(activity, CheckoutActivity::class.java)
