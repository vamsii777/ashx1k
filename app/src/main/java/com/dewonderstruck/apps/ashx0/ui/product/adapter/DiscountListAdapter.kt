...
class DiscountListAdapter(private val dataBindingComponent: DataBindingComponent, private val callback: NewsClickCallback) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    inner class MyViewAllHolder internal constructor(val viewAllBinding: ItemDiscountListAdapterViewAllBinding) : RecyclerView.ViewHolder(viewAllBinding.root)

    inner class MyViewHolder internal constructor(val binding: ItemDiscountListAdapterBinding) : RecyclerView.ViewHolder(binding.root) {
